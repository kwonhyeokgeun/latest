...
navigator.mediaDevices.getDisplayMedia({
    ...
    sendPC['share'] = createSenderPeerConnection(stream, 'share',is_audio_true, 1);
...
function shareDisconnect(stream) {   //공유자의 화면설정
...
function setPresenterShareView(stream) {
	...
	a.onclick = function() {shareDisconnect(stream);};
    a.innerHTML = '종료하기';
