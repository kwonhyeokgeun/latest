...
function chatScrollDown(){     //스크롤 밑으로 내리기
    var chat_scroll = document.getElementById('mCSB_1_container'); 
...
function show_chat(){
    ...
    if($('.header .r_hcont .second .h_btn.chat').hasClass("off")){
        $('.header .r_hcont .second .h_btn.chat').removeClass("off").addClass("on");
        $('.chatbox').slideToggle();
    }
}
