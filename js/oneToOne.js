...
function set11(id,name){
	...
	document.getElementById('my_video').muted = "muted";
...
function setOther(message) {
    ...
    if(message.user1Id == roomLeader) {
        document.getElementById(message.user1Id).innerHTML = "1 : 1 대화 중";
        document.getElementById(message.user1Id).setAttribute('style', 'background:#8f8f8f;');
        document.getElementById(message.user1Id).parentNode.parentNode.setAttribute('style', 'opacity:1;');
    }
    else{
    ...
    if(message.user2Id == roomLeader) {
        document.getElementById(message.user2Id).innerHTML = "1 : 1 대화 중";
        document.getElementById(message.user2Id).setAttribute('style', 'background:#8f8f8f;');
        document.getElementById(message.user2Id).parentNode.parentNode.setAttribute('style', 'opacity:1;');
    }
    else{
...
function endOther(message) {
    ...
    if(message.user1Id == roomLeader) {
        document.getElementById(message.user1Id).innerHTML = "1 : 1 대화신청";
        document.getElementById(message.user1Id).setAttribute('style', 'background:#ffcc00;');
        document.getElementById(message.user1Id).parentNode.parentNode.setAttribute('style', 'opacity:0;');
        document.getElementById(message.user1Id).parentNode.parentNode.removeAttribute('style');
    }
    else{
    ...
    if(message.user2Id == roomLeader) {
        document.getElementById(message.user2Id).innerHTML = "1 : 1 대화신청";
        document.getElementById(message.user2Id).setAttribute('style', 'background:#ffcc00;');
        document.getElementById(message.user2Id).parentNode.parentNode.setAttribute('style', 'opacity:0;');
        document.getElementById(message.user2Id).parentNode.parentNode.removeAttribute('style');
    }
    else{
...
function setOther_come(id) {
    ...
    if(id == roomLeader) {
        ...
        document.getElementById(id).parentNode.parentNode.setAttribute('style', 'opacity:1;');
    }
    else {
        makeChat_1_1(id);
    }
...
function makeChat_1_1(id){
    ...
    chat.setAttribute('style', 'opacity:1;');
