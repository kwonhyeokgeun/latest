...
const socket = io('https://betterteaching.xyz', {secure: true, 'reconnect': true, 'reconnection delay': 500, 'max reconnection attempts': 10});
...
=======
    if(socketId === roomLeader && roomType ==='meeting' && userStreams['meeting']['myId']!=null){   
>>>>>>> 49d02216469884e13b1ffa0b71f10badc733b5fe
